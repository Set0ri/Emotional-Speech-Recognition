function [cepstra, spectra, pspectrum, lpcas, F, M] = rastaplp(samples, sr, dorasta, modelorder,varargin)
...
[wintime, hoptime, dither] = ...
    process_options(varargin, 'wintime', 0.025, 'hoptime', 0.010,'dither', 0);
